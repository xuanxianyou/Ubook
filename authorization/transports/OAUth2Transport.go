...
// HTTP Handler
func MakeHttpHandler(ctx context.Context, endpoints endpoint.OAuth2Endpoints, tokenService services.TokenService, clientService services.ClientDetailsService, logger log.Logger) http.Handler {
	r := mux.NewRouter()
...
func makeOAuth2AuthorizationContext(tokenService services.TokenService, logger log.Logger) kithttp.RequestFunc {
...
func makeClientAuthorizationContext(clientDetailsService services.ClientDetailsService, logger log.Logger) kithttp.RequestFunc {
